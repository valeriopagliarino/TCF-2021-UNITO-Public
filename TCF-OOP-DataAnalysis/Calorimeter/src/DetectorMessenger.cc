...
// ********************************************************************
//
/// \file electromagnetic/Calorimeter/src/DetectorMessenger.cc
...
:G4UImessenger(),fDetector(Det),
 ...
 fTalPosiCmd(nullptr)
{ 
  fTestemDir = new G4UIdirectory("/calorimeter/");
  fTestemDir->SetGuidance(" detector control.");
  
  fDetDir = new G4UIdirectory("/calorimeter/det/");
  fDetDir->SetGuidance("detector construction commands");
      
  fMaterCmd = new G4UIcmdWithAString("/calorimeter/det/setMat",this);
  fMaterCmd->SetGuidance("Select material of the box.");
  fMaterCmd->SetParameterName("choice",false);
  fMaterCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
  
  fWMaterCmd = new G4UIcmdWithAString("/calorimeter/det/setWorldMat",this);
  ...
  fSizeXCmd = new G4UIcmdWithADoubleAndUnit("/calorimeter/det/setSizeX",this);
  ...
  fSizeYZCmd = new G4UIcmdWithADoubleAndUnit("/calorimeter/det/setSizeYZ",this);
  ...
  fMagFieldCmd = new G4UIcmdWithADoubleAndUnit("/calorimeter/det/setField",this);
  ...
  fTalNbCmd = new G4UIcmdWithAnInteger("/calorimeter/det/tallyNumber",this);
  ...
  fTalDefCmd = new G4UIcommand("/calorimeter/det/tallyDefinition",this);
  ...
  //
  fTalMat = new G4UIcommand("/calorimeter/det/tallyMat",this);
  fTalMat->SetGuidance("Specify the tally material.");
  fTalMat->SetGuidance("  material name");
  //
  G4UIparameter* fTalNbMat = new G4UIparameter("tallyNb",'i',false);
  fTalNbMat->SetGuidance("tally number : from 0 to tallyNumber");
  fTalMat->SetParameter(fTalNbMat);
  //
  G4UIparameter* fTalNMat = new G4UIparameter("tallyMat",'s',false);
  fTalNMat->SetGuidance("tally material");
  fTalMat->SetParameter(fTalNMat);
  //
  ...
  fTalPosiCmd = new G4UIcommand("/calorimeter/det/tallyPosition",this);
...
{ 
  ...
  if (command == fTalPosiCmd)
   ...
   if (command == fTalMat)
   {
      ...
      std::istringstream is(newValue);
      is >> num >> mat;
      fDetector->SetTallyMaterial(num, mat);
   }
}
