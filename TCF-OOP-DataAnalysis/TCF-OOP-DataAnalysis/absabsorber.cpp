...
AbsAbsorber::AbsAbsorber()
{

}

//______________________________________________________________________________
QString AbsAbsorber::renderTallyMaterial(int j) const
{
    return QString("\n") + QString("/calorimeter/det/tallyMat ")
            + QString::number(j) + QString(" ") + QString::fromStdString("ABS");
}

//______________________________________________________________________________
QString AbsAbsorber::renderAll(int j) const
{
    QString output;
...
//______________________________________________________________________________
void AbsAbsorber::initializeMaterial(std::vector<materialDisplay> &reg)
{
