...
#ifndef ABSABSORBER_H
#define ABSABSORBER_H
#define MAT_NAME std::string("ABS")
#define MAT_A std::string("ABS")
#define MAT_Z std::string("ABS")
#define MAT_RHO 1050

#include<absorber.h>


class AbsAbsorber : public Absorber
{
public:
    AbsAbsorber();
