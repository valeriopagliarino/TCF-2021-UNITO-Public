...
PmmaAbsorber::PmmaAbsorber()
{

}

//______________________________________________________________________________
void PmmaAbsorber::initializeMaterial(std::vector<materialDisplay> &reg)
{
...
//______________________________________________________________________________
QString PmmaAbsorber::renderTallyMaterial(int j) const
{
    return QString("\n") + QString("/calorimeter/det/tallyMat ")
            + QString::number(j) + QString(" ") + QString::fromStdString("PMMA");
}

//______________________________________________________________________________
QString PmmaAbsorber::renderAll(int j) const
{
    QString output;
