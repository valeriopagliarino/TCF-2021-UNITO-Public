...
#ifndef LIQUIDCALOABSORBER_H
#define LIQUIDCALOABSORBER_H
#define MAT_NAME std::string("H2O")
#define MAT_A std::string("---")
#define MAT_Z std::string("2x1, 1x8")
#define MAT_RHO 1000

#include<absorber.h>


class LiquidCaloAbsorber : public Absorber
{
public:
    LiquidCaloAbsorber();
